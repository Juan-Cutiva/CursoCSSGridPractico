					...
					return (
						<div id="llave" key={item.key}>
							...
							>
								...
								<hr className="w-auto text-gray-100 mb-4 sm:mb-2 mt-3 sm:mt-0"/>
								...
								<div className="flex gap-[10%]">
									<div className="flex w-[45%] items-center justify-between border-b-[1px] border-r-[1px] rounded-br-xl">
										<div className="flex flex-col sm:flex-row">
											...
											<p className="sm:pl-2 tracking-[0.0125rem] font-bold">{item.driver1A}</p>
										</div>
										<img src={item.imgD1} alt={item.driver1} className="mr-[0.4rem] h-12 hidden sm:block" />
									</div>
									<div className="flex w-[45%] items-center justify-between border-b-[1px] border-r-[1px] rounded-br-xl">
										<div className="flex flex-col sm:flex-row">
											<p className="tracking-[0.0125rem]">{item.driver2}</p>
											<p className="sm:pl-2 tracking-[0.0125rem] font-bold">{item.driver2A}</p>
										</div>
										<img src={item.imgD2} alt={item.driver2} className="mr-[0.4rem] h-12 hidden sm:block" />
									</div>
								</div>
								<div id="img" className="mt-4 flex justify-center rounded-xl pt-8">
									<img src={item.Car} alt={item.name} className="max-w-[30rem] min-w-[21rem] ml-2 sm:ml-5" />
								</div>
							</section>
						</div>
					);
